...
def propose_edit(para: str, strategy: str, context_before: str, context_after: str) -> str:
    ...
    system = (
        ...
        "headers. Preserve ALL canonical numbers exactly (136, 103, 33, 68.1%, "
        "36.5%, 0.734, 0.701, 1.21/100k, 27.9%, 0.086, 0.043). Preserve ALL "
        "citations in their exact form. Keep word count within ±10 of the "
        "original. Use active voice where possible. Write in English."
    )
    prompt = (
        f"STRATEGY: {strategy}\n\n"
        f"CONTEXT BEFORE:\n{context_before[-500:]}\n\n"
